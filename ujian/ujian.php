...
$title = "Data Ujian - BMKG E-learning";
        ...
        <div class="container-fluid px-4">
            ...
            <div class="card">
                <div class="card-header">
                    ...
                    <a href="nilai-ujian.php" class="btn btn-primary float-end ms-1"><i class="fa-solid fa-plus"></i> Tambah Data Ujian</a>
                    <div class="dropdown" style="margin-top: -30px;">
                        <button class="btn btn-primary dropdown-toggle float-end" type="button" data-bs-toggle="dropdown">Cetak</button>
                        <ul class="dropdown-menu">
                            ...
                            <li>
                                <button type="button" onclick="printDoc()" class="dropdown-item" data-bs-toggle="modal" data-bs-target="#mdlCetak"><i class="fa-solid fa-magnifying-glass"></i> Nilai Ujian</button>
                            </li>
                        </ul>
                ...
                <div class="modal-body">
                    ...
                    <select name="no" id="no" class="form-select">
                        ...
                        while ($data = mysqli_fetch_array($dataUjian)) { ?>
                            <option value="<?= $data['no_ujian'] ?>"><?= $data['no_ujian'] . '-' . $data['nim'] . '-' . $data['jurusan'] ?></option>
                        <?php
                        }
