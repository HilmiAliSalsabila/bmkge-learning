...
$title = "Update Dosen - BMKG E-learning";
...
$queryDosen = mysqli_query($koneksi, "SELECT * FROM tbl_dosen WHERE id = $id ");
            ...
            <form action="proses-dosen.php" method="POST" enctype="multipart/form-data">
                <div class="card">
                    <div class="card-header">
                        <span class="h5 my-2"><i class="fa-solid fa-pen-to-square"></i> Update Dosen</span>
