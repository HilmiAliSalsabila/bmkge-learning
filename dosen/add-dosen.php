...
$title = "Tambah Dosen - BMKG E-learning";
...
if ($msg == 'cancel') {
    ...
    <i class="fa-solid fa-xmark"></i> Tambah Dosen gagal, NIP sudah ada..
...
if ($msg == 'notimage') {
    $alert = '<div class="alert alert-warning alert-dismissible fade show" role="alert">
    <i class="fa-solid fa-xmark"></i> Tambah Dosen gagal, file yang anda upload bukan gambar..
    <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
  </div>';
}
...
if ($msg == 'oversize') {
    $alert = '<div class="alert alert-warning alert-dismissible fade show" role="alert">
    <i class="fa-solid fa-xmark"></i> Tambah Dosen gagal, maksimal ukuran gambar 1MB..
    <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
  </div>';
}
    ...
    <main>
        <div class="container-fluid px-4">
            ...
            <ol class="breadcrumb mb-4">
                ...
                <li class="breadcrumb-item "><a href="dosen.php">Dosen</a></li>
            ...
            <form action="proses-dosen.php" method="POST" enctype="multipart/form-data">
                ...
                <div class="card">
                    <div class="card-header">
                        <span class="h5 my-2"><i class="fa-solid fa-square-plus"></i> Tambah Dosen</span>
                    ...
                    <div class="card-body">
                        <div class="row">
                            ...
                            <div class="col-4 text-center px-5">
                                <img src="../asset/image/profile.png" class="mb-3" width="40%" alt="">
